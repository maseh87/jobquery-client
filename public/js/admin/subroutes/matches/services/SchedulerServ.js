...
var later = function(){
  ...
  console.log("what is matchesSortedByInt in schedulerServ", matchesSortedByInterest)
  var usersForSchedule = FilterService.usersForSchedule;
  var opportunities = FilterService.opportunities;
  console.log("what is opportunites in schedulerserv", opportunities)
  ...
  var scheduleAllMatches =function() {
    //for everything interestLevel
      console.log("what is matchesSortedByInt", matchesSortedByInterest)
